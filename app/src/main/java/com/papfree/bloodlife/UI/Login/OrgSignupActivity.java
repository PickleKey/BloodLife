...
public class OrgSignupActivity extends BaseActivity {
    ...
    private EditText mEditTextOrgnameCreate, mEditTextEmailCreate;
    private String mOrgName,mUserEmail, mPassword;
    ...
    public void initializeScreen() {
        mEditTextOrgnameCreate = (EditText) findViewById(R.id.input_orgname);
        mEditTextEmailCreate = (EditText) findViewById(R.id.input_email);
        LinearLayout linearLayoutCreateAccountActivity = (LinearLayout) findViewById(R.id.linear_layout_org_create_account_activity);
    ...
    public void onCreateAccountPressed(View view) {
        ...
        mOrgName = mEditTextOrgnameCreate.getText().toString();
        ...
        boolean validUserName = isUserNameValid(mOrgName);
            ...
            public void onSuccess(Map<String, Object> result) {
                ...
                mFirebaseRef.resetPassword(mUserEmail, new Firebase.ResultHandler() {
                    ...
                    public void onSuccess() {
                        ...
                        SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(OrgSignupActivity.this);
    ...
    private void createUserInFirebaseHelper() {
        ...
        final Firebase userLocation = new Firebase(Constants.FIREBASE_URL_ORGS).child(encodedEmail);
        /**
        ...
        userLocation.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.getValue() == null) {
                    ...
                    User newUser = new User(mOrgName, encodedEmail, timestampJoined);
    ...
    private boolean isUserNameValid(String userName) {
        ...
        if (userName.equals("")) {
            mEditTextOrgnameCreate.setError(getResources().getString(R.string.error_cannot_be_empty));
            return false;
        }
    ...
    private void showErrorToast(String message) {
        Toast.makeText(OrgSignupActivity.this, message, Toast.LENGTH_LONG).show();
    }
}